...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-to-r from-rose-500 via-orange-500 to-amber-500 text-white rounded-xl shadow-lg hover:shadow-xl hover:from-rose-600 hover:via-orange-600 hover:to-amber-600",
        destructive:
          "bg-destructive text-destructive-foreground rounded-xl shadow-lg hover:bg-destructive/90 hover:shadow-xl",
        outline:
          "border border-input bg-background rounded-xl shadow-sm hover:bg-accent hover:text-accent-foreground",
        secondary:
